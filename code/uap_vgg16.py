...
Original file is located at
    https://colab.research.google.com/drive/1N3STB1K5JtKPFP29hoQG16-6GevAdGVX
"""
...
# Load pretrained VGG16 model tanpa top layers (fully connected)
base_model = VGG16(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
for layer in base_model.layers[:-5]:  # Freeze semua kecuali 5 lapisan terakhir
    layer.trainable = False

# Bangun model baru di atas VGG16
...
train_generator = train_datagen.flow_from_directory(
    train_dir,
    target_size=(224, 224),  # Disesuaikan dengan input shape VGG16
    batch_size=32,
